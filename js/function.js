...
(function ($, owner) {
    ...
    var ajax_ = function (url, data, type, timeout, success, fail, beforeSend) {
...
//?            IS_DEBUG = true;
    ...
    var ajax = function (url, data, type, timeout, success, failure, beforeSend) {
        var reqHeader = {
            "Content-Type": "application/json"
        };
        if (beforeSend) {
        ...
        $.ajax(url, {
            ...
            success: function (result) {
                //........................................
                if (IS_DEBUG) {console.log("SUCCESS: "+result);}
		try {
...
//        success(res);
    ...
    owner.forget_password = function (url, data, success, fail) {
        ajax(url, data, 'POST', 120000, success, fail, false);
    };
    ...
    //delete node
    owner.delete_event = function (url, data, success, fail) {
        //		ajax(url, data, 'DELETE', TIMEOUT, success, fail, true);
        ajax(url, data, 'POST', 120000, success, fail, true);
    }
    ...
    owner.set_cancel_override = function (url, data, success, fail) {
        ajax(url, data, 'POST', TIMEOUT, success, fail, true);
    }
    ...
    //gateway status
    owner.get_gateway_status = function (url, data, success, fail) {
        ajax(url, data, 'GET', TIMEOUT, success, fail, true);
    }
    ...
    //node_add_info
    owner.node_add_info = function (url, data, success, fail) {
        ajax(url, data, 'GET', TIMEOUT, success, fail, true);
    }
