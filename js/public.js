...
//		var language = settings_login_info.language;
		alert('alert: ' + content);
//?		if (mui.isFunction(callback)) {
//?			plus.nativeUI.alert(content, callback, "", poer_language.label_ok(language));
//?		} else {
//?			plus.nativeUI.alert(content, function() {}, "", poer_language.label_ok(language));
//?		}
	}

	owner.toast2 = function(content, options) {
alert('toast2: ' + content);
//?		var settings_login_info = poer_function.getLocalStorage("login_info");
//?		var language = settings_login_info.language;
//?		plus.nativeUI.alert(content, function() {}, "", poer_language.label_ok(language));
...
window.status='showWaiting: ' + title;
