...
//	  var LANCABLE_SERVER_HOST = "http://192.168.1.117:8012";
	...
	owner.check_gatewayV2 = function(userId, locateId, ssid) {
		return LANCABLE_SERVER_USERS_NEW + "/" + userId + "/" + locateId + "/" + ssid + "/CheckGatewayV2";
	}
	...
	owner.add_node_v2 = function(userId, locateId, nodeSN) {
		return LANCABLE_SERVER_USERS_NEW + "/" + userId + "/" + locateId + "/node/" + nodeSN+"/V2";
	}
...
//	}
	...
	owner.delete_event_all = function(userId) {
		return LANCABLE_SERVER_USERS_NEW + "/" + userId + "/eventList/deleteAllEventMessage";
	}
	
	owner.delete_event = function(userId) {
		return LANCABLE_SERVER_USERS_NEW + "/" + userId + "/eventList/deleteEventMessage";
	}
	...
	owner.set_cancel_override = function(userId, nodeId) {
		return LANCABLE_SERVER_USERS_NEW + "/" + userId + "/nodeList/" + nodeId + "/OverrideSetting";
	}
...
//	}
	...
	//gateway_status
	owner.get_gateway_status = function(ip){
		return "http://" + ip + "/config?command=status";
	}
	...
	//设备添加状态
	owner.node_add_info = function(userId, locateId, node_sn) {
		return LANCABLE_SERVER_USERS_NEW + "/" + userId + "/" + locateId + "/nodeAddInfo/" + node_sn;
	}
